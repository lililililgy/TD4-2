...
class ParticleSystem2DRenderingPipeline : public IRenderingPipeline {
    struct CameraData {
...
public:
    ParticleSystem2DRenderingPipeline(Asset::AssetCollection* assetCollection);
    ~ParticleSystem2DRenderingPipeline() override;
...
private:
    ...
    StructuredBuffer<Particle2D> particleBuffer_;
