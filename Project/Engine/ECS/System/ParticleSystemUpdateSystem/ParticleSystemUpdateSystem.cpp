                ...
                if (p.remainingLifetime <= 0.0f) {
                    ...
                    if (ghost.velocityOverLifetime.enabled) {
                        Vector3 linearVelocity(
                            ...
                            EvaluateMinMaxCurve(ghost.velocityOverLifetime.z, normalizedTime, p.randomValue)
                        );
